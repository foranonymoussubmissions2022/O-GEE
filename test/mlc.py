...
if __name__=="__main__":
    ...
    df = pd.read_csv('mlc_data/wde_multilabel_train.csv')
    header = list(df.head())
    ...
    df2 = pd.read_csv('mlc_data/wde_multilabel_test.csv')
    ...
    df3 = pd.read_csv('mlc_data/wde_multilabel_dev.csv')
    ...
    for epoch in range(EPOCHS):
        ...
        if f1_score_micro > max_score:
            ...
            outputs = outputs >= 0.5
            targets = np.array(targets)
            classes = list(pd.read_csv("mlc_data/wde_multilabel_test.csv").columns)[2:]
            tp = 0
            fp = 0
            fn = 0
            ...
            with open("mlc_output/wde_with_focal_loss.csv", "w") as f, open('mlc_data/wde_multilabel_test.csv',"r") as f2:
